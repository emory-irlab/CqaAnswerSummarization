...
public class ranking {
	...
	//static ArrayList<String> answers;//the answer list (text)
	static int qlength;
	static int[] alength;
	//static ArrayList<String> rateList;//the rate for each answer
	static HashMap<String, Integer> qMap;//words--frequency
	static ArrayList<HashMap<String, Integer>> answerList;//word--frequency
	//static ArrayList<Integer> alength;//the length of each answer
	
	public ranking(String q, String[] as)
	{
		this.question = q;
